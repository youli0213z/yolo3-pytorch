...
# 2、生成标注文件保存的路径
CKanno_dir = 'D:/pytorch/毕业论文/yolo3-pytorch/VOC/Annotations'
...
def main():
    base_dir = 'D:/pytorch/毕业论文/yolo3-pytorch/VOC'  # step1 这里是一个新的文件夹，存放转换后的图片和标注
    #image_dir = os.path.join(base_dir, 'images')  # 在上述文件夹中生成images，annotations两个子文件夹
    anno_dir = os.path.join(base_dir, 'Annotations')
    #mkr(image_dir)
    mkr(anno_dir)
    # 4、
    origin_image_dir = 'D:/pytorch/毕业论文/mmdetection/data/coco/val2017'  # step 2原始的coco的图像存放位置
    # 5、
    origin_anno_dir = 'D:/pytorch/毕业论文/mmdetection/data/coco/annotations'  # step 3 原始的coco的标注存放位置
